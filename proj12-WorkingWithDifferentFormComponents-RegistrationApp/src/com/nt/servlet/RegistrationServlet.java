...
public class RegistrationServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(marstatus==null)
			marstatus="not married";
		String education=req.getParameter("education");
		String languages[]=req.getParameterValues("languages");
		if(languages==null)
			languages=new String[]{"no languages known"};
		String hobbies[]=req.getParameterValues("hobbies");
		if(hobbies==null)
			hobbies=new String[] {"No hobbies are there"};
		...
		pw.println("<h1 style='color:green;text-align:center'>languages known::"+Arrays.deepToString(languages)+"</h1>");
		pw.println("<h1 style='color:green;text-align:center'>Hobbies::"+Arrays.deepToString(hobbies)+"</h1>");
		...
		pw.println("<h1 style='color:green;text-align:center'>Fburl::"+fburl+"</h1>");
